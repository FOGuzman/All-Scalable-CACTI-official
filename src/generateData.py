...
parser.add_argument('--augmented_data_dir', default="./dataset_mat/", type=str)
...
parser.add_argument('--trainData', default=1, type=int)
parser.add_argument('--validationData', default=1, type=int)
